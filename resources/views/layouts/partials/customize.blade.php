...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="row gx-2">
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight">
                        <span class="hover-overlay mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0" src="{{asset('falcon/assets/img/generic/falcon-mode-default.jpg')}}" alt=""/>
                        </span>
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark">
                        <span class="hover-overlay mb-2 rounded d-block">
                                <img class="img-fluid img-prototype mb-0" src="{{asset('falcon/assets/img/generic/falcon-mode-dark.jpg')}}" alt=""/></span>
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto">
                        <span class="hover-overlay mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0" src="{{asset('falcon/assets/img/generic/falcon-mode-auto.jpg')}}" alt=""/>
                        </span>
        ...
        <div class="text-center mt-5"><img class="mb-4" src="{{asset('falcon/assets/img/icons/spot-illustrations/47.png')}}" alt="" width="120" />
            ...
            <p class="fs-10">Get Falcon now and create beautiful dashboards with hundreds of widgets.</p><a class="mb-3 btn btn-primary" href="https://github.com/rohan9222" target="_blank">Purchase</a>
        </div>
    </div>
</div>
